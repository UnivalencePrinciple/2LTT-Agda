...
module 2LTT_C.Diagram_Signatures.Reedy-fibration where

open import 2LTT_C.Diagram_Signatures.Definition public
...
match-obj-zero-sort-≅-⊤ : {i j k : Level}{ℒ : Inv-Exo-cat i j}
                           {M : Exo-Functor {i} {j} {lsuc k} {k} (iexo-cat ℒ) (ExoUniv-is-Exo-cat k)}
                           (K : ℒ ⟅ zeroᵉ ⟆) → matching-object {i} {j} {k} {ℒ} {M} {zeroᵉ} {K} ≅ (C ⊤)
match-obj-zero-sort-≅-⊤ {i} {j} {k} {ℒ} {M} K = (λ a → c (star)) ,ᵉ
