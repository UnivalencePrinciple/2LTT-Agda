...
module 2LTT_C.Exotypes.Functions where
...
≅-refl = idᵉ ,ᵉ (idᵉ ,ᵉ ((λ a → reflᵉ) ,ᵉ λ b → reflᵉ))
...
≅-sym (F ,ᵉ (G ,ᵉ (lh ,ᵉ rh))) = (G ,ᵉ (F ,ᵉ (rh ,ᵉ lh)))

≅-trans : {i j k : Level} {A : UUᵉ i} {B : UUᵉ j} {C : UUᵉ k} → A ≅ B → B ≅ C → A ≅ C
≅-trans {i} {j} {k} (F ,ᵉ (G ,ᵉ (lh ,ᵉ rh))) (F' ,ᵉ (G' ,ᵉ (lh' ,ᵉ rh')))
        = ((F' ∘ᵉ F) ,ᵉ
            ((G ∘ᵉ G') ,ᵉ
              ((λ a → exo-concat (exo-ap G (lh' (F a))) (lh a)) ,ᵉ
...
Σᵉ-functor : {i j : Level}{A B : UUᵉ i}{P : A → UUᵉ j}{Q : B → UUᵉ j}
             ...
             → Σᵉ A P → Σᵉ B Q
Σᵉ-functor {i} {j} {A} {B} {P} {Q} f0 f1 = λ (a ,ᵉ p) → (f0 a ,ᵉ f1 a p)
...
Σᵉ-iso-cong : {i j : Level}{A B : UUᵉ i}{P : A → UUᵉ j}{Q : B → UUᵉ j}
           ...
           → Σᵉ A P ≅ Σᵉ B Q
Σᵉ-iso-cong {i} {j} {A} {B} {P} {Q} f0 {(f0' ,ᵉ lh ,ᵉ rh)} f1 {G}
   = Σᵉ-functor f0 (λ (a : A) → (f1 a)) ,ᵉ
     Σᵉ-functor f0' (λ (b : B) → (pr1ᵉ (G (f0' b))) ∘ᵉ (exo-tr Q (exo-inv (rh b)))) ,ᵉ
      (λ {(a ,ᵉ p) → dep-pair-=ᵉ (f0' (f0 a) ,ᵉ pr1ᵉ (G (f0' (f0 a))) (exo-tr Q (exo-inv (rh (f0 a))) (f1 a p)))
                                         (a ,ᵉ p)
                                         (lh a ,ᵉ
                                         exo-concat
                                           ...
                                           (exo-concat
                                             ...
                                             (exo-concat
                                               ...
                                               (exo-concat
                                                 ...
                                                 ((pr1ᵉ (pr2ᵉ (G a))) p)))))}) ,ᵉ
     (λ {(b ,ᵉ q) → dep-pair-=ᵉ (f0 (f0' b) ,ᵉ f1 (f0' b) (pr1ᵉ (G (f0' b)) (exo-tr Q (exo-inv (rh b)) q)))
                                         (b ,ᵉ q)
                                         (rh b ,ᵉ
                                          exo-concat
